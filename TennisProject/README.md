...
ctb_rer_bounce.cbm -> boune_model
model_best.pt -> ball_model
model_tennis_court -> court model

python main.py --path_input_video output.mp4 --path_output_video main_output.mp4 --path_bounce_model ctb_regr_bounce.cbm --path_court_model model_tennis_court_det.pt --path_bounce_model model_best.pt 
