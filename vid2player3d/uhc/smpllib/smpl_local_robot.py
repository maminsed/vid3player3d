...
from vid3player.vid2player3d.uhc.khrylib.mocap.skeleton_local import Skeleton
from vid3player.vid2player3d.uhc.khrylib.mocap.skeleton_mesh_local import Skeleton as SkeletonMesh
from vid3player.vid2player3d.uhc.smpllib.smpl_parser import (
    SMPL_Parser,
    SMPLH_Parser,
    SMPLX_Parser,
)
from vid3player.vid2player3d.uhc.utils.geom import quadric_mesh_decimation
from vid3player.vid2player3d.uhc.utils.flags import flags
...
def get_joint_geometries(
    ...
    print(f"debug: 95: geom_dir: {geom_dir}")
...
class Robot:
    ...
    def set_model_xml_path(self, model_xml_path):
        print(f"debug: 1146: setting xml_path: {model_xml_path}")
    ...
    def load_from_skeleton(
        ...
        if self.mesh:
            ...
            print(f"debug: 1341: geom_dir: {self.geom_dir}")
