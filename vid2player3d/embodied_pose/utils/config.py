...
def load_cfg(args):
    ...
    print(f"debug: 119: args.checkpoint: {args.checkpoint}")
...
def get_args(benchmark=False):
    custom_parameters = [
        ...
        {"name": "--cfg", "type": str, "default": "amass_im", "help": "configuration file."},
        ...
        {"name": "--motion_id", "type": int, "default": -1, "help": "motion_id to playback."},
        ...
        {"name": "--export_dataset", "action": "store_true", "default": False,
            "help": "Export the simulated motion to a dataset file."},
    ]
